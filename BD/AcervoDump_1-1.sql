...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 20-Jun-2023 às 22:27
...
CREATE TABLE IF NOT EXISTS `follow` (
  `FLWUSER` int(11) NOT NULL,
  `FLWARTIST` int(11) NOT NULL,
  KEY `FLWARTIST` (`FLWARTIST`),
  KEY `FLWUSER` (`FLWUSER`)
...
INSERT INTO `users` (`USRID`, `USRNAME`, `URSDESC`, `USREMAIL`, `USRPASSWORD`) VALUES
(1, 'Gustavo', NULL, 'teste@email.com', '24062004Gu#'),
(2, 'undefined', NULL, 'undefined', 'undefined'),
(3, 'undefined', NULL, 'undefined', 'undefined'),
(4, 'Luis', NULL, 'exemplo2@email.com', '123456');
COMMIT;
